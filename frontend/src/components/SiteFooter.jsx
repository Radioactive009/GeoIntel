        ...
        <div className="max-w-[1440px] mx-auto px-6 py-12">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
                <div className="col-span-2 md:col-span-1">
                    <p className="font-display text-lg font-extrabold text-ink tracking-tight">GeoIntel</p>
                    <p className="text-[13px] text-muted leading-relaxed mt-2 max-w-xs">
                ...
                <nav aria-label="Sections">
                    <h2 className="text-[11px] font-bold uppercase tracking-widest text-muted mb-3">Sections</h2>
                    <ul className="space-y-2 text-[13px]">
                        {[
                            ...
                            <li key={to}>
                                <Link to={to} className="text-body hover:text-accent transition-colors">{label}</Link>
                            </li>
                        ))}
                    </ul>
                </nav>
                ...
                <nav aria-label="Study">
                    <h2 className="text-[11px] font-bold uppercase tracking-widest text-muted mb-3">Study</h2>
                    <ul className="space-y-2 text-[13px]">
                        {[
                ...
                <nav aria-label="About this site">
                    <h2 className="text-[11px] font-bold uppercase tracking-widest text-muted mb-3">About</h2>
                    <ul className="space-y-2 text-[13px]">
                        <li><Link to="/about" className="text-body hover:text-accent transition-colors">About us</Link></li>
                        <li><Link to="/methodology" className="text-body hover:text-accent transition-colors">Methodology</Link></li>
                        <li><Link to="/sources" className="text-body hover:text-accent transition-colors">Sources</Link></li>
                    </ul>
                </nav>

                <div>
                    <h2 className="text-[11px] font-bold uppercase tracking-widest text-muted mb-3">Follow</h2>
                    <ul className="space-y-2 text-[13px]">
                        <li>
                            <a
            ...
            <div className="pt-6 border-t border-rule flex flex-col sm:flex-row items-center justify-between gap-4">
